...
const plans = [
  {
    ...
    description: t("1 day free, then 7.99€/mo. Cancel anytime.", "1 jour gratuit, puis 7,99€/mois. Résiliez à tout moment."),
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#05060a] text-white">
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-6 pb-16 pt-16 text-center lg:px-8 lg:pt-24">
        ...
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.35 }} className="mt-4 text-xs text-white/30">{t("1 day free — then 7.99€/mo. Cancel anytime.", "1 jour gratuit — puis 7,99€/mois. Résiliez à tout moment.")}</motion.p>
      </section>
