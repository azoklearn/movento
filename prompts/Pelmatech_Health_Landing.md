## Pelmatech Health Landing Prompt
...
All images above are referenced by `import x from "@/assets/<file>"`.
...
- Hero footer strip (under the headline row, mt-12 pt-5):
  ...
  Three flex children:
    ...
    2. `<span className="flex items-center gap-6"><span><span className="text-white">01</span> / 04</span><span>Next</span></span>`
    3. "Scroll to Explore"
