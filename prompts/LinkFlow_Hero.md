## LinkFlow Hero Prompt

Build a fullscreen hero section for "LinkFlow" — an AI workflow automation product — with a boomerang-looping video background captured to canvas.
